    ...
    <div className="min-h-[calc(100vh-5rem)] bg-background w-full py-12 lg:py-24 relative overflow-hidden">
      ...
      <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center max-w-2xl mx-auto mb-16">
          ...
          <p className="text-lg text-muted-foreground">Whether you need help setting up your digital arboretum or want to discuss enterprise pricing, our agronomy experts are here to help.</p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 items-start">
          ...
          >
            <div className="glass-panel p-8 rounded-3xl border-l-4 border-primary">
              ...
              <p className="text-muted-foreground mb-6">Our agronomy team is online and ready to assist you with real-time data analysis.</p>
